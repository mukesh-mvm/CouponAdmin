...
const DealOnFire = () => {
    ...
    const fetchData = async () => {
        try {
            const res = await axios.get(baseurl + "/api/dealOnFire/getAll");
    ...
    const handleDelete = async (record) => {
        try {
            const response = await axios.delete(`${baseurl}/api/dealOnFire/delete/${record}`)
            if (response) {
                message.success("Status updated succesfully");
                fetchData();
            }
    ...
    const handlePut = async (values) => {
        ...
        try {
            const response = await axios.put(
                `${baseurl}/api/dealOnFire/update/${editingSubCategory?._id}`,
                postData
            );
            // console.log(response.data);
    ...
    return (
        <div>
            ...
            <Modal
                title={editingSubCategory ? "Edit Deal On Fire" : "Add Deal On Fire"}
                open={isModalOpen}
